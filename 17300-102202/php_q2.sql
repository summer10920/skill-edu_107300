...
INSERT INTO `good_t11` (`id`, `user`, `blog`) VALUES
(7, 'test', 1),
(8, 'test', 3),
(9, 'test', 4),
(10, 'test', 5),
...
INSERT INTO `user_t6` (`id`, `acc`, `pwd`, `mail`) VALUES
...
INSERT INTO `visit_t3` (`id`, `date`, `num`) VALUES
(1, '2019-02-10', 0),
(2, '0000-00-00', 1);
...
INSERT INTO `vote_t13` (`id`, `text`, `parent`, `num`) VALUES
(1, '問題一：你最常做什麼運動來促進健康體能呢?', 0, 0),
(2, '問題二：二手菸沒有安全劑量，只要有暴露，就會有危險，請問它會造成身體上哪些危害?', 0, 0),
(3, '健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 1, 1),
(4, '仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 1, 2),
(5, '球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 1, 3),
(6, '舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 1, 0),
(7, '增加罹患冠狀動脈心臟病及罹病死亡之風險。', 2, 5),
(8, '對孩子的的健康會產生許多影響，例如容易咳嗽或打噴嚏、罹患氣喘或讓症狀更嚴重、會因刺激耳咽管，感染中耳炎、肺功能較差、容易罹患呼吸道疾病等。', 2, 6),
(9, '孕婦吸入二手菸易造成流產、早產、胎盤早期剝離、子宮感染等疾病。', 2, 1),
(10, '長期的暴露會造成更嚴重的胸腔問題和過敏症，還會增加心臟病和肺癌的罹患率。', 2, 1),
(11, '以上皆是。', 2, 3),
(19, 'aaa', 0, 0),
(28, '1', 19, 1),
(29, '2', 19, 0),
...
-- 資料表索引 `visit_t3`
--
ALTER TABLE `visit_t3`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `vote_t13`
--
ALTER TABLE `vote_t13`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`),
  ADD KEY `id_2` (`id`);
...
--
-- 使用資料表 AUTO_INCREMENT `blog_t7`
--
ALTER TABLE `blog_t7`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- 使用資料表 AUTO_INCREMENT `good_t11`
--
ALTER TABLE `good_t11`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- 使用資料表 AUTO_INCREMENT `user_t6`
--
ALTER TABLE `user_t6`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- 使用資料表 AUTO_INCREMENT `visit_t3`
--
ALTER TABLE `visit_t3`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 使用資料表 AUTO_INCREMENT `vote_t13`
--
ALTER TABLE `vote_t13`
